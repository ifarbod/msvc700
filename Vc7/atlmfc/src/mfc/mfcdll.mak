...
!ifndef LIBNAME
!error LIBNAME is not defined. LIBNAME=MFC70 builds the prebuilt DLL.
!endif
...
!if "$(MONOLITHIC)" == "1"
TARGDEFS=$(TARGDEFS) /D_AFX_OLE_IMPL /D_AFX_DB_IMPL /D_AFX_NET_IMPL /D_AFX_MONOLITHIC
...
!else
TARG_STATIC=MFCS70$(PF)$(TARGTYPE)
!endif
...
DEFFILE=$(PLATFORM)\MFC70$(PF)$(TARGTYPE).DEF
...
STATICLINK_OBJS=$D\stdafx.obj $D\nolib.obj \
	$D\appmodul.obj $D\dllmodul.obj $D\oleexp.obj $D\dumpstak.obj $D\sockexp.obj $(DAO)

# Always compile /Zi (generate PDB) for mfcs70[u][d].lib, since we never get a chance to have the
# linker generate a PDB from /Z7 info

CVOPTS_STATIC=/Zi

CPPFLAGS_STATIC=\
	$(CL_MODEL) /D_AFX_MFCS $(CL_OPT:Z7=Zi) $(DEFS) $(OPT) $(EH) /Gy $(CVOPTS_STATIC) /Fd..\..\lib\$(PLATFORM)\$(TARG_STATIC).pdb
...
$D\daocore.obj: $D\stdafx.obj daocore.cpp
	cl @<<
/c $(CPPFLAGS_STATIC) /Yustdafx.h /Fp$D\stdafxs.pch daocore.cpp
<<

$D\daodfx.obj: $D\stdafx.obj daodfx.cpp
	cl @<<
/c $(CPPFLAGS_STATIC) /Yustdafx.h /Fp$D\stdafxs.pch daodfx.cpp
<<

$D\daoview.obj: $D\stdafx.obj daoview.cpp
	cl @<<
/c $(CPPFLAGS_STATIC) /Yustdafx.h /Fp$D\stdafxs.pch daoview.cpp
<<
